...
import com.civil.interfaces.web.CivilWebs;
...
@EnableVzsHandlebars
@ComponentScan(basePackageClasses = { CivilWebs.class, VzsLocale.class })
public class CivilWebServletApplicationContextConfig extends AbstractVzsWebMvcConfig {
